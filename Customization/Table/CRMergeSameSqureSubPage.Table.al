table 73209607 "BLRCRMergeSameSqureSubPage"
{
    ...
    fields
    {
        ...
        field(73209592; "BLRTotalFinalAmount"; Decimal)
        {
            ...
            CalcFormula = sum("BLRCRMergeSameSqureSubPage"."BLRMS_Final Annual Amount" where("BLRID" = field("BLRID")));
        }
        field(73209593; "BLRTotalAnnualAmount"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("BLRCRMergeSameSqureSubPage"."BLRMS_Annual Amount" where("BLRID" = field("BLRID")));
        }
        field(73209594; "BLRTotalRoundOff"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("BLRCRMergeSameSqureSubPage"."BLRMS_Round off" where("BLRID" = field("BLRID")));
        }
        field(73209595; "BLRTotalFirstAnnualAmount"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("BLRCRMergeSameSqureSubPage"."BLRMS_Final Annual Amount" where("BLRID" = field("BLRID"), "BLRMS_Year" = const(1)));
        }
    }
    keys
    {
