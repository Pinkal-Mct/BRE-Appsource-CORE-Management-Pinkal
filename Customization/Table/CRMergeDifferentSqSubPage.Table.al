table 73209605 "BLRCRMergeDifferentSqSubPage"
{
    ...
    fields
    {
        ...
        field(73209591; "BLRTotalFinalAmount"; Decimal)
        {
            ...
            CalcFormula = sum("BLRCRMergeDifferentSqSubPage"."BLRMD_Final Annual Amount" where("BLRID" = field("BLRID")));

        }
        field(73209592; "BLRTotalAnnualAmount"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("BLRCRMergeDifferentSqSubPage"."BLRMD_Annual Amount" where("BLRID" = field("BLRID")));

        }
        field(73209593; "BLRTotalRoundOff"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("BLRCRMergeDifferentSqSubPage"."BLRMD_Round off" where("BLRID" = field("BLRID")));

        }
        field(73209594; "BLRTotalFirstAnnualAmount"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("BLRCRMergeDifferentSqSubPage"."BLRMD_Final Annual Amount" where("BLRID" = field("BLRID"), "BLRMD_Year" = const(1)));
