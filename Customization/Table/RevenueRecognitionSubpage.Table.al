table 73209679 "BLRRevenueRecognitionSubpage"
{
    ...
    fields
    {
        ...
        field(73209583; "BLRTotal Amount(Day)"; Decimal)
        {
            ...
            CalcFormula = sum("BLRRevenueRecognitionSubpage"."BLRRR - Method 1 (Day)" where("BLRContract ID" = field("BLRContract ID")));
        }
        field(73209584; "BLRTotal Amount(Month)"; Decimal)
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = sum("BLRRevenueRecognitionSubpage"."BLRRR - Method 2 (Month)" where("BLRContract ID" = field("BLRContract ID")));
        }
    }
    keys
    {
