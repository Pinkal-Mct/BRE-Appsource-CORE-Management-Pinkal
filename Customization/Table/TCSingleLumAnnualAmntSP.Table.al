table 73209700 "BLRTCSingleLumAnnualAmntSP"
{
    ...
    fields
    {
        ...
        field(73209591; "BLRTotalFinalAmount"; Decimal)
        {
            ...
            CalcFormula = sum("BLRTCSingleLumAnnualAmntSP"."BLRSL_Final Annual Amount" where("BLRID" = field("BLRID")));
        }

        field(73209592; "BLRTotalAnnualAmount"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("BLRTCSingleLumAnnualAmntSP"."BLRSL_Annual Amount" where("BLRID" = field("BLRID")));
        }

        field(73209593; "BLRTotalRoundOff"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("BLRTCSingleLumAnnualAmntSP"."BLRSL_Round off" where("BLRID" = field("BLRID")));
        }
        ...
        {
            FieldClass = FlowField;
            CalcFormula = sum("BLRTCSingleLumAnnualAmntSP"."BLRSL_Final Annual Amount" where("BLRID" = field("BLRID"), "BLRSL_Year" = const(1)));
        }
